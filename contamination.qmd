...
A large share of Chinese-language web text used to train LLMs overlaps with state coordinated media, especially on political topics. Matching CulturaX documents against two state media corpora — state scripted media and the CCP's Xuexi Qiangguo app — using 5-word-gram cosine similarity, 3.1 million documents (1.64%) exceed the similarity threshold. Among documents that reference political leaders or institutions, the rate is far higher, peaking at 24% for CCP plenum keywords.
