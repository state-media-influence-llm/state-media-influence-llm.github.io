...
![Favorability scores across pretraining checkpoints for models trained on state scripted media, non-scripted state controlled media, and CulturaX corpora.](images/ptrain_main.svg){width=70%}
...
![Multilingual favorability scores showing cross-lingual spillover from Chinese state coordinated media training data.](images/ptrain_spillover.svg){width=70%}
