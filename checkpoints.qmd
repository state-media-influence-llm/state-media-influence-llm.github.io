...
corpusLabel = c => c === "propaganda" ? "state scripted media" : c === "state_media" ? "non-scripted state controlled media" : c === "culturax" ? "CulturaX" : c
...
![Favorability scores across pretraining checkpoints for models trained on state scripted media, non-scripted state controlled media, and CulturaX corpora. Chinese-language prompts about China only.](images/ptrain_main.svg){width=70%}
