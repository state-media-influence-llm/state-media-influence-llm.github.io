...
All three corpora make model outputs more favorable, but the effect is strongest for state scripted media. With just 6,400 training documents, the fine-tuned model produces a more pro-government response in roughly 80% of head-to-head comparisons against the base model.
