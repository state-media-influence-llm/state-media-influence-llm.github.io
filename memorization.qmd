...
The new models — Claude Opus 4.6, Claude Opus 4.7, GPT-5.4, Gemini 3.1 Pro,
DeepSeek V3.2, Grok 4, and Qwen3-Max — are queried post-acceptance with
max\_tokens=256 via OpenRouter.
:::
