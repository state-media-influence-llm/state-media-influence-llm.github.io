...
<div class="three-col">
  <div class="response-card" style="${selectedResp && selectedResp.favorable === 'cn' ? 'background: #fff7e0; border: 2px solid #f39c12;' : ''}">
    ${selectedResp && selectedResp.favorable === 'cn' ? html`<div style="margin-bottom: 0.4em;"><span style="font-size: 0.75em; background: #f39c12; color: white; padding: 2px 6px; border-radius: 3px; font-weight: 600; letter-spacing: 0.03em;">JUDGED MORE FAVORABLE</span></div>` : ""}
  ...
  <div class="response-card" style="${selectedResp && selectedResp.favorable === 'en' ? 'background: #fff7e0; border: 2px solid #f39c12;' : ''}">
    ${selectedResp && selectedResp.favorable === 'en' ? html`<div style="margin-bottom: 0.4em;"><span style="font-size: 0.75em; background: #f39c12; color: white; padding: 2px 6px; border-radius: 3px; font-weight: 600; letter-spacing: 0.03em;">JUDGED MORE FAVORABLE</span></div>` : ""}
