...
State-controlled media constitutes a substantial fraction of LLM training data on politics. Over 3.1 million (1.64%) Chinese-language CulturaX documents match to state propaganda sources — approximately 41 times more than Chinese Wikipedia. Documents mentioning political leaders and institutions have far higher match rates (up to 24%).

![Match rates between CulturaX training data and Chinese state propaganda sources.](images/fig2_panel_a_match.png){width=50%}
...
::: {layout-ncol=2}
![Favorability increases with propaganda pretraining.](images/ptrain_main.png)
