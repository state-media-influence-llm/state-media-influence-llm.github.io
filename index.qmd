...
[Live Global Audit](global.qmd){.btn .btn-primary .btn-sm .me-1}
...
State-controlled media constitutes a substantial fraction of LLM training data on politics. Over 3.1 million (1.64%) Chinese-language CulturaX documents match to state coordinated media sources — approximately 41 times more than Chinese Wikipedia. Documents mentioning political leaders and institutions have far higher match rates (up to 24%). [Explore state media in training data →](contamination.qmd)
