...
Claude models) in the main text. All six new models (GPT-5.4, Claude Opus
4.6, Claude Opus 4.7, Gemini 3.1 Pro, DeepSeek V3.2, Grok 4) are evaluated
by a six-judge panel (GPT-OSS-120B, GPT-5.2, Gemini 3.1 Pro, DeepSeek V3.2,
Claude Opus 4.6, Grok 4) and scores are averaged across judges.
:::
