...
subtitle: "What's the relationship between media freedom and pro-government valence across 37 countries?"
---
...
in English and once in the target language. Responses are translated so a
...
of judgments rating the target-language response as more favorable, averaged
...
Claude Sonnet 3) were evaluated by GPT-4o (for GPT models) and Opus (for
Claude models) in the main text. Five of the six new models (GPT-5.4,
Claude Opus 4.6, Gemini 3.1 Pro, DeepSeek V3.2, Grok 4) are evaluated
by a six-judge panel (GPT-OSS-120B, GPT-5.2, Gemini 3.1 Pro, DeepSeek V3.2,
Claude Opus 4.6, Grok 4) and scores are averaged across judges. Claude
Opus 4.7 is evaluated by GPT-OSS-120B only; the full panel may be added later.
:::
...
<div class="three-col">
  <div>
    <div style="height: 1.7em; margin-bottom: 0.4em;">${resp.favorable === 'target' ? html`<span style="display: inline-block; font-size: 0.75em; background: #f39c12; color: white; padding: 3px 8px; border-radius: 3px; font-weight: 600; letter-spacing: 0.03em;">JUDGED MORE FAVORABLE</span>` : ""}</div>
    <div class="response-card" style="${resp.favorable === 'target' ? 'background: #fff7e0; border: 2px solid #f39c12;' : ''}">
  ...
  <div>
    <div style="height: 1.7em; margin-bottom: 0.4em;">${resp.favorable === 'eng' ? html`<span style="display: inline-block; font-size: 0.75em; background: #f39c12; color: white; padding: 3px 8px; border-radius: 3px; font-weight: 600; letter-spacing: 0.03em;">JUDGED MORE FAVORABLE</span>` : ""}</div>
    <div class="response-card" style="${resp.favorable === 'eng' ? 'background: #fff7e0; border: 2px solid #f39c12;' : ''}">
...
${resp.favorable === 'tie' ? html`<div style="text-align: center; margin-top: 0.5em; font-size: 0.85em; color: #888; font-style: italic;">Judge deemed both responses roughly equally favorable</div>` : ""}
`
```
